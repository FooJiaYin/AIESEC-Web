...
<?php
  ...
  if($_GET["sync"]==1||$_GET["sync"]==5){
    ...
    for($i=0;$i<20;$i++){
      ...
      $sobj[$i]->{getsffieldname(9,"Match")} = $match;
      $sobj[$i]->{getsffieldname(9,"Realize")} = $realize;
    }
...
try {
  $sf_data_IGCDP=$mySforceConnection->retrieve("Id,Name,".getsffieldname(9,"Match").",".getsffieldname(9,"Realize"),"Opportunity",$sf_id_array_IGCDP);
...
<table  class="table">
    <thead>
        <tr>
            ...
            <td>SF Opp</td>
            <td>Match</td>
            <td>Match on SF<br>(<?php echo getsffieldname(9,"Match"); ?>)</td>
            <td>Realize</td>
            <td>Realize on SF<br>(<?php echo getsffieldname(9,"Realize"); ?>)</td>
        </tr>
    </thead>
    <tbody>
        <?php
            for ($i=0; $i < 20; $i++) { 
                ...
                $sf_IGCDP_match = $sf_data_IGCDP[$i]->{getsffieldname(9,"Match")} ;
                $sf_IGCDP_realize = $sf_data_IGCDP[$i]->{getsffieldname(9,"Realize")} ;
                echo "<td ";
...
try {
  $sf_data_IGIP=$mySforceConnection->retrieve("Id,Name,".getsffieldname(9,"Match").",".getsffieldname(9,"Realize"),"Opportunity",$sf_id_array_IGIP);
} 
catch (Exception $e) 
{
  echo $mySforceConnection->getLastRequest();
    ...
    <tbody>
        <?php
            ...
            for ($i=0; $i < 20; $i++) { 
                ...
                $sf_IGIP_match = $sf_data_IGIP[$i]->{getsffieldname(9,"Match")} ;
                $sf_IGIP_realize = $sf_data_IGIP[$i]->{getsffieldname(9,"Realize")} ;
                echo "<td ";
...
try {
  $sf_data_OGCDP=$mySforceConnection->retrieve("Id,Name,".getsffieldname(9,"Match").",".getsffieldname(9,"Realize"),"Opportunity",$sf_id_array_OGCDP);
} 
catch (Exception $e) 
{
  echo $mySforceConnection->getLastRequest();
    ...
    <tbody>
        <?php
            for ($i=0; $i < 20; $i++) { 
                ...
                echo "<td>".$match."</td>";
                $sf_OGCDP_match = $sf_data_OGCDP[$i]->{getsffieldname(9,"Match")} ;
                $sf_OGCDP_realize = $sf_data_OGCDP[$i]->{getsffieldname(9,"Realize")} ;
                echo "<td ";
...
try {
  $sf_data_OGIP=$mySforceConnection->retrieve("Id,Name,".getsffieldname(9,"Match").",".getsffieldname(9,"Realize"),"Opportunity",$sf_id_array_OGIP);
} 
catch (Exception $e) 
{
  echo $mySforceConnection->getLastRequest();
    ...
    <tbody>
        <?php
            for ($i=0; $i < 20; $i++) { 
                ...
                echo "<td>".$match."</td>";
                $sf_OGIP_match = $sf_data_OGIP[$i]->{getsffieldname(9,"Match")} ;
                $sf_OGIP_realize = $sf_data_OGIP[$i]->{getsffieldname(9,"Realize")} ;
                echo "<td ";
