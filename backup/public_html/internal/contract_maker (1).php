...
<body valign="center" ; class="font14">
  <div class="logo">
    <img style="width:20%" src="http://s3.amazonaws.com/eztable-static/asset/ie_bye/logo.png">
  </div>
  <div style="text-align:right;margin:30px 0">
    <div><?php echo $_GET["CONTRACTID"]; ?></div>
    <div>整合型服務合作協議書</div>
  </div>
  <div>
    <table style="margin-left:30px">
      <tr>
        <td>立協議書人：</td>
        <td><span class='underline'>三二三網路科技股份有限公司</span> （以下簡稱甲方）</td>
      </tr>
      <tr>
        <td></td>
        <td>
          <span class='underline'><?php echo $_GET["COMPANYNAME"]; ?>（以下簡稱乙方）</span>
        </td>
      </tr>
    </table>
  </div>
   ...
   <tr>
    ...
    緣，乙方為拓展商品或服務之銷售範圍，達成業務目標，資就旗下所開設  <span class='underline'><?php echo $_GET["ACCNAME"]; ?></span>  所提供之商品或服務，與甲方進行整合型服務合作，包括但不限於：利用甲方於其所建置並經營之EZTABLE易訂網（以下簡稱「EZTABLE」或「本網站」），網址(http://www.eztable.com)之網路訂位系統服務、委由EZTABLE或其他網路平台代理銷售乙方發行之電子或實體之餐券、住宿券或其他禮券(以下合稱「禮券」)及提供相關服務、規劃電子商務及其他專案促銷活動等。綜上，甲、乙雙方同意訂立本「整合型服務合作協議書」(以下稱「本協議書」)並共同遵守以下條款：<br>
      <br>
      <br>
  ...
  <br>
<table style="margin:0px auto;border:1px solid;width:85%;" border="1px solid" rules="all" cellpadding="10px">
<?php
    if ($_GET["RMONTHLYFEE"]== 0 && $_GET["RCOMMISSION"]== 0)
    ...
    <tr><td class=\"col-2-5 textcenter\"> 電子商務服務 </td> <td class=\"col-2-5 textcenter\">".$_GET["COMMISSION"]." %</td></tr>"; }

      else if ($_GET["RMONTHLYFEE"]!= 0 && $_GET["RCOMMISSION"]== 0) {
          echo "<tr><td class=\"col-2-5 textcenter\">項目</td> <td class=\"col-2-5 textcenter\">價格(NTD)</td></tr>
    ...
    *甲方同意提供乙方網路訂位系統服務優惠，<br>
    優惠每家網路訂位服務費：".$_GET["RMONTHLYFEE"]."元/月。<br>
          ...
          echo "<tr><td class=\"col-2-5 textcenter\">項目</td> <td class=\"col-2-5 textcenter\">價格(NTD)</td></tr>
    <tr><td class=\"col-2-5 textcenter\"> 網路訂位系統服務 </td> <td class=\"col-2-5 textcenter\">".$_GET["MONTHLYFEE"]." </td></tr>
    <tr><td class=\"col-2-5 textcenter\"> 電子商務服務 </td> <td class=\"col-2-5 textcenter\"><S>".$_GET["COMMISSION"]." %</S></td></tr>
    <tr><td class=\"col-2-5 textcenter\"; colspan=\"2\"> 專屬優惠方案 </td> </tr>
    <tr><td class=\"col-2-5 textleft\" ; colspan=\"2\">
    *甲方同意以".$_GET["RCOMMISSION"]."%收益分潤與乙方配合電子商務服務<br>
    （含銀行手續費）。<br>
    </td> </tr>";
      }
      else if ($_GET["RMONTHLYFEE"]!= 0 && $_GET["RCOMMISSION"]!= 0) {
    ...
    <tr><td class=\"col-2-5 textleft\" ; colspan=\"2\">
    *甲方同意提供乙方網路訂位系統服務優惠，<br>
    優惠每家網路訂位服務費：".$_GET["RMONTHLYFEE"]."元/月。</td></tr>
    <tr><td class=\"col-2-5 textleft\" ; colspan=\"2\">
    *甲方同意以".$_GET["RCOMMISSION"]."%收益分潤與乙方配合電子商務服務<br>
    （含銀行手續費）。<br> </td></tr>";
      }
...
<?php
    if ($_GET["NOTCHARGEFROM"]!= 0 && $_GET["SPECIALTERM"]== "" && $_GET["RMONTHLYFEE"]== 0 && $_GET["RCOMMISSION"]== 0)
...
<?php
  ...
  <?php if ($_GET["ONLYCHANNEL"] == "YES") {echo "<li>乙方瞭解並同意，於本協議書合作期間，甲方經營之EZTABLE為乙方獨家且唯一之網路訂位系統服務合作通路。</li>";} ?>
    ...
    <li>甲方得就實際代理銷售之交易金額收取每筆服務報酬 <u><?php echo $_GET["RCOMMISSION"]; ?>%</u> ，發行禮券之優惠內容，另以餐廳合作資料表載明。
    </li>
...
（二）電子商務服務費用結帳方式：<br>
  ...
  <tr><td colspan="10">
  <table style="margin:0px auto;border:1px solid;width:90%;" border="1px solid" rules="all" cellpadding="20px">
