...
<body>
<table class="invoicetable font14 tableborder" style="margin:0px auto;">
  <tbody>
    <tr>
...
<!-- 	  <tr>
  ...
  <tr>
  	...
  	10091台北市中正區羅斯福路四段68號8樓<br>
  	8F., No.68, Sec. 4, Roosevelt Rd., Zhongzheng Dist., Taipei City 100, Taiwan (R.O.C.)<br>
  	+886-2-2367-5893 | +886-2-2367-5893<br>
...
收據編號：<span class="red-id"><?php echo $_GET["ARID"]; ?></span><br>
會址：台北市中正區羅斯福路四段68號8樓<br>
統一編號：99042880<br>
立案字號：台內設字號第0920034615號<br>
</td></tr>
...
<tr><td colspan="2">
  ...
  <tr><td class="tdborder tdborder-right tdpadding">茲收到</td><td class="tdborder tdpadding"><?php if($_GET["RECIPTNAME"]=="Same as Account Name") echo $_GET["ACCNAME"]."OKOK2"; else echo $_GET["RECIPTNAME"]."OKOK"; ?></td></tr>
<tr><td class="tdborder  tdborder-right tdpadding">項目</td>
<td class="tdborder tdpadding">
<?php if($_GET["ITEM"]=="ICXGIP") echo '<span class="big-big-check">☑'; else echo "□";?></span>專案費用-全球人才實習計畫
<span class="big-check">□</span>捐款
<span class="big-check">□</span>贊助款<br>
<?php if($_GET["ITEM"]=="ICXGCDP") echo '<span class="big-big-check">☑'; else echo "□";?></span>專案費用-全球青年在地發展計畫
<span class="big-check">□</span>其他 _________
</td>
</tr>
...
<tr>
      <td colspan="2" style="padding:20px 20px"><span class="tag">秘書長：</span><span class="tag">經辦：</span><span class="tag">會章：</span></td>
</tr>
</table>
